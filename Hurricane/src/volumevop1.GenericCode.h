...
namespace CodeGenerator
{
 ...
 // Generate by threadIdx
			...
			// Generate by IndexToVoxelCenter
			glm::vec3 geo1_volumevop1_IndexToVoxelCenter_P = IndexToVoxelCenter(geo1_volumevop1_threadIdx_idx, geo1_volumevop1_volumevopglobal1_OpInput1);

			// Generate by relbbox1
			glm::vec3 geo1_volumevop1_relbbox1_bbdelta = relbbox(geo1_volumevop1_volumevopglobal1_OpInput2, geo1_volumevop1_IndexToVoxelCenter_P);
			...
			glm::vec3 geo1_volumevop1_relbbox2_bbdelta = relbbox(geo1_volumevop1_volumevopglobal1_OpInput1, geo1_volumevop1_IndexToVoxelCenter_P);
			...
			geo1_volumevop1_ramp1_ramp = rampparm(geo1_volumevop1_vectofloat1_fval2/*, &geo1_volumevop1_ramp1_ramp, &geo1_volumevop1_ramp1_ramp_the_basis_strings, &geo1_volumevop1_ramp1_ramp_the_key_positions, &geo1_volumevop1_ramp1_ramp_the_key_values, &geo1_volumevop1_ramp1_ramp_the_color_space, &geo1_volumevop1_ramp1_ramp_struct*/);
			...
			geo1_volumevop1_ramp2_rampx = rampparm(geo1_volumevop1_vectofloat1_fval2/*, &geo1_volumevop1_ramp2_rampx, &geo1_volumevop1_ramp2_rampx_the_basis_strings, &geo1_volumevop1_ramp2_rampx_the_key_positions, &geo1_volumevop1_ramp2_rampx_the_key_values, &geo1_volumevop1_ramp2_rampx_the_color_space, &geo1_volumevop1_ramp2_rampx_struct*/);
			...
			// Generate by SetVoxelValueVector3
			SetVoxelValueVector3(geo1_volumevop1_threadIdx_idx, geo1_volumevop1_add2_sum, geo1_volumevop1_volumevopglobal1_OpInput1);
