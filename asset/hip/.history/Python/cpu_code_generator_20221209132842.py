    ...
    for input_node_key in global_input:
        ...
        if ("volumevopglobal" in input_node_key) or ("geometryvopglobal" in input_node_key):
            for input_port in input_node:
                ...
                else if input_port["is_OpInput"] == "True":
                    result += "CGGeometry<" + input_port["data_type"] + ">* " + input_port["variable_name"] + "buffer" + ", "
                else:
        ...
        if ("volumevopglobal" in input_node_key) or ("geometryvopglobal" in input_node_key):
            for input_port in input_node:
                ...
                if input_port["is_buffer"] == "True":
                    ...
                    result += input_port["variable_name"] +  "->GetGeometryRawData()" + ", "  #i.e. geo1_volumevop1_volumevopglobal1_OpInput1->GetGeometryRawData(),
                else:
