    ...
    namespace Field
    {
        namespace GenericCode
        {
            ...
            __host__ __device__ inline glm::vec3 relbbox(CGGeometry::RawData file, glm::vec3 pos)
            {
                ...
                bbdelta[1] = (pos[1] - file.bbox.min[1]) / (file.bbox.upperBound[1] - file.bbox.lowerBound[1]);
                bbdelta[2] = (pos[2] - file.bbox.min[2]) / (file.bbox.upperBound[2] - file.bbox.lowerBound[2]);
                return bbdelta;
            }
