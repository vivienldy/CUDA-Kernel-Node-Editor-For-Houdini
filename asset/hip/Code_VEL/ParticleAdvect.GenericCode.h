...
float geo1_ParticleAdvect_volumesamplefile1_volumevalue = volumesamplefile(geo1_ParticleAdvect_geometryvopglobal1_OpInput2, geo1_ParticleAdvect_geometryvopglobal1_P);

 // Generate by volumesamplefile2
float geo1_ParticleAdvect_volumesamplefile2_volumevalue = volumesamplefile(geo1_ParticleAdvect_geometryvopglobal1_OpInput2, geo1_ParticleAdvect_geometryvopglobal1_P);

 // Generate by volumesamplefile3
float geo1_ParticleAdvect_volumesamplefile3_volumevalue = volumesamplefile(geo1_ParticleAdvect_geometryvopglobal1_OpInput2, geo1_ParticleAdvect_geometryvopglobal1_P);
...
namespace CodeGenerator
{
        namespace GenericCode
        {
                    ...
                    int idx)
                {
                        ...
                        // Generate by threadIdx1
                        int geo1_ParticleAdvect_threadIdx1_idx = idx;

                        // Generate by add1
                        float geo1_ParticleAdvect_add1_sum = geo1_ParticleAdvect_geometryvopglobal1_age + geo1_ParticleAdvect_geometryvopglobal1_TimeInc;

                        // Generate by createColor
                        glm::vec3 geo1_ParticleAdvect_createColor__Cd = createColor(geo1_ParticleAdvect_geometryvopglobal1_age, geo1_ParticleAdvect_geometryvopglobal1_Cd, geo1_ParticleAdvect_geometryvopglobal1_OpInput1, geo1_ParticleAdvect_threadIdx1_idx);
