...
__geo1_solver1_d_s_particle_advect_multiply3_product_debug_buffer->loadHostToDevice();
    ...
    // Compute threads num
    int numOfThreads = geo1_solver1_d_s_particle_advect_geometryvopglobal1_Pbuffer->getSize();
    // Compute blocks num
