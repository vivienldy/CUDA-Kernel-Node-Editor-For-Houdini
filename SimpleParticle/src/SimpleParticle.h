...
int main() // ? 还是main函数应该是现在单独的main.cpp 里
{
    ...
    auto geo1_solver1_d_s_pointvop2__DEBUG_geometryvopglobal1_vbuffer = new CGBuffer(
        "v", 
        geo1_solver1_d_s_pointvop2__DEBUG_geometryvopglobal1_Pbuffer->size(), 
        glm::vec3(0.f));
    ...
    auto __geo1_solver1_d_s_pointvop2__DEBUG_add2_sum_debug_buffer = new CGBuffer(
        "__geo1_solver1_d_s_pointvop2__DEBUG_add2_sum_debug_buffer",
        geo1_solver1_d_s_pointvop2__DEBUG_geometryvopglobal1_Pbuffer->size(),
        glm::vec3(0.f));
    auto __geo1_solver1_d_s_pointvop2__DEBUG_multiply2_product_debug_buffer = new CGBuffer(
        "__geo1_solver1_d_s_pointvop2__DEBUG_multiply2_product_debug_buffer",
        geo1_solver1_d_s_pointvop2__DEBUG_geometryvopglobal1_Pbuffer->size(),
        glm::vec3(0.f));
    auto __geo1_solver1_d_s_pointvop2__DEBUG_add1_sum_debug_buffer = new CGBuffer(
        "__geo1_solver1_d_s_pointvop2__DEBUG_add1_sum_debug_buffer",
        geo1_solver1_d_s_pointvop2__DEBUG_geometryvopglobal1_Pbuffer->size(),
        glm::vec3(0.f));
    auto __geo1_solver1_d_s_pointvop2__DEBUG_multiply1_product_debug_buffer = new CGBuffer(
        "__geo1_solver1_d_s_pointvop2__DEBUG_multiply1_product_debug_buffer",
        geo1_solver1_d_s_pointvop2__DEBUG_geometryvopglobal1_Pbuffer->size(),
        glm::vec3(0.f));
    auto __geo1_solver1_d_s_pointvop2__DEBUG_curlnoise1_noise_debug_buffer = new CGBuffer(
        "__geo1_solver1_d_s_pointvop2__DEBUG_curlnoise1_noise_debug_buffer",
        geo1_solver1_d_s_pointvop2__DEBUG_geometryvopglobal1_Pbuffer->size(),
        glm::vec3(0.f));
    auto __geo1_solver1_d_s_pointvop2__DEBUG_multiply3_product_debug_buffer = new CGBuffer(
        "__geo1_solver1_d_s_pointvop2__DEBUG_curlnoise1_noise_debug_buffer",
        geo1_solver1_d_s_pointvop2__DEBUG_geometryvopglobal1_Pbuffer->size(),
        glm::vec3(0.f));
    ...
    auto geo1_solver1_d_s_pointvop2__DEBUG_geometryvopoutput1_Pbuffer = geo1_solver1_d_s_pointvop2__DEBUG_geometryvopglobal1_Pbuffer;
  ...
  for(int i = startFrame; i < endFrame; ++i){
    ...
    geo1_solver1_d_s_pointvop2__DEBUG_geometryvopoutput1_Pbuffer->SaveAsObj(outputObjFilePath);
  }  
}
